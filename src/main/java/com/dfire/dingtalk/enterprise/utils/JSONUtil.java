...
public class JSONUtil {
     ...
     */
    public static boolean compareJSONObject(JSONObject json1, JSONObject json2) {
        ...
        for (String key : json1.keySet()) {
            ...
            try {
                ...
                if (!compareJSONObject(sonJSON1, sonJSON2)) {
                    return false;
                }
            } catch (Exception e) {
                try {
                    ...
                    if (!compareJSONArray(sonArray1, sonArray2)) {
                        return false;
                    }
                } catch (Exception e1) {
                    try {
     ...
     */
    private static boolean compareJSONArray(JSONArray array1, JSONArray array2) {
