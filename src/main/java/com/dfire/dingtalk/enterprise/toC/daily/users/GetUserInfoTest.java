package com.dfire.dingtalk.enterprise.toC.daily.users;
 ...
 */
public class GetUserInfoTest  extends TestBase {
    public static Logger logger = LoggerFactory.getLogger(GetUserInfoTest.class);
    StringBuilder sb = new StringBuilder();

    @Test(dataProvider = "JsonDataProvider", groups = "shopQRCode")
    public void testGetUserInfoTest(JsonDataProvider jsonDataProvider) {
        //调用http服务
        try {
            List<String> pathUrl = getPathUrl("users/v1/get_user_info");
