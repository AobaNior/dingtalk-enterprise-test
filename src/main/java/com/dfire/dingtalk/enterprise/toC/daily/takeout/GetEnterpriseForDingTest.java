...
public class GetEnterpriseForDingTest extends TestBase {
    public static Logger logger = LoggerFactory.getLogger(GetEnterpriseForDingTest.class);
    StringBuilder sb = new StringBuilder();

    @Test(dataProvider = "JsonDataProvider")
    public void testGetEnterpriseForDingTest(JsonDataProvider jsonDataProvider) {
        //调用http服务
        try {
            List<String> pathUrl = getPathUrl("enterprise/takeout/v1/get_enterprise_for_ding");
